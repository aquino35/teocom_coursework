...
%*******************************************************************
[sig,Fs]=audioread('hw03gp01t08.wav');  %Get overall sampling frequency
...
%
fg=fft(g);                    %Spectrum of input signal (Fund. Reg.)
sfg=fftshift(fg);             %Spectrum of input signal (Princ. Reg.)
asfg=abs(sfg);                %Magnitude of spectrum of input signal
%
...
ylabel('Magnitude')
title('Magnitude of Spectrum of Interfering Signal')
grid
%
figure
plot(fkq,asfxc)
