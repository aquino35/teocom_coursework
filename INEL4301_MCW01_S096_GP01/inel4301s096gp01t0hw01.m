...
f1=220;             %First frequency component (A3) of s(t) 
f2=329;             %Second frequency component (E4) of s(t) 
f3=440;             %Third frequency component of (A4) s(t) 
fc=2000;            %Frequency of carrier signal > 2*fm 
fm=500;             %Bandwidth of desired signal s(t) 
...
%%TRANSMITTER SYSTEM****************************** 
%% 
s=(3*cos(2*pi*f1*t)-2*cos(2*pi*f2*t)+2*cos(2*pi*f3*t))/8; 
g=1*cos(2*pi*800*t);    %Interference signal g(t) 
...
Mb=101;             %Order of band-pass filter 
