...
f1=784;             %First frequency component (G5) of s(t) 
f2=880;             %Second frequency component (A5) of s(t) 
f3=988;             %Third frequency component of (B5) s(t) 
fc=2500;            %Frequency of carrier signal > 2*fm 
fm=1000;             %Bandwidth of desired signal s(t) 
...
g=1*cos(2*pi*1200*t)+1*cos(2*pi*1500*t);    %Interference signal g(t) 
